...
`I can manage Group with high security ⚙️ This Bot Is Only For study Groups I you want Contact and get! .` 
"""

buttons = [
    [
        InlineKeyboardButton(
            text="Contact", url="t.me/Dacchu_xy"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="Channel", url="https://t.me/DreamStudyIn"),
        InlineKeyboardButton(
            text="Study Group", url="https://t.me/KarnatakaDreamWorld"
        ),
    ],
]
...
DONATE_STRING = """No need.. I'm Not Yet asked"""
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1958911759 and DONATION_LINK:
            update.effective_message.reply_text(
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Group Manager Setup Done")
        except Unauthorized:
            LOGGER.warning(
